...
- **WebApp-конструктор** — поиск, живой предпросмотр карточки на Canvas и четыре пресета: Классика, Роза, Полароид, Нуар. Зум по тапу, переключатель RU/оригинального названия, тогглы оценки/жанров/подписи.
